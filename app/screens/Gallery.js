        ...
        if (state.inspectedUser.userType) {
            ...
            return (
                <View style={{backgroundColor: '#ffffff', flex: 1, flexDirection: 'row'}}>
                    <OpenContent owner={{
                        lastName: type !== 'Coach' ? state.inspectedUser.lastname || this.props.inspectedUser.lastname : team.category.label + ' ' + team.division.label,
                        firstName: type !== 'Coach' ? state.inspectedUser.firstname || this.props.inspectedUser.firstname : team.category.label + ' ' + team.division.label
